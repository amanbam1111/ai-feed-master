...
export function AuthPage() {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithLinkedIn, signInWithGitHub, user, loading } = useAuth();
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (signupData.password !== signupData.confirmPassword) {
      // Toast will be shown by the auth context
      return;
    }
        ...
        <Card className="glass-card p-8 w-full max-w-md">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-accent/50" />
            </div>
          ...
          <div className="space-y-3">
            <Button 
              ...
              variant="outline"
              className="w-full bg-accent/20 border-accent/50 hover:bg-accent/30"
              size="lg"
              disabled={isSubmitting}
            >
